...
abstract class User implements ActiveRecordInterface
{
    ...
    public function setAdds($v)
    {
        ...
        if ($this->adds !== $v) {
            $this->adds = $v;
            $this->modifiedColumns[UserTableMap::COL_ADDS] = true;
        }
    ...
    public function setJoindate($v)
    {
        ...
        if ($this->joindate !== $v) {
            $this->joindate = $v;
            $this->modifiedColumns[UserTableMap::COL_JOINDATE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UserTableMap::translateFieldName('Adds', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : UserTableMap::translateFieldName('Birth', TableMap::TYPE_PHPNAME, $indexType)];
            $this->birth = (null !== $col) ? (string) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : UserTableMap::translateFieldName('Groups', TableMap::TYPE_PHPNAME, $indexType)];
            $this->groups = (null !== $col) ? (int) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : UserTableMap::translateFieldName('Role', TableMap::TYPE_PHPNAME, $indexType)];
            $this->role = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : UserTableMap::translateFieldName('Joindate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->joindate = (null !== $col) ? (string) $col : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_ADDS)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_JOINDATE)) {
            $modifiedColumns[':p' . $index++]  = 'joindate';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'phone':
                        ...
                        break;
                    case 'birth':
                        $stmt->bindValue($identifier, $this->birth, PDO::PARAM_STR);
                        break;
                    case 'email':
                        $stmt->bindValue($identifier, $this->email, PDO::PARAM_STR);
                        break;
                    case 'groups':
                        $stmt->bindValue($identifier, $this->groups, PDO::PARAM_INT);
                        break;
                    case 'status':
                    ...
                    case 'role':
                        ...
                        break;
                    case 'joindate':
                        $stmt->bindValue($identifier, $this->joindate, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[6] => $this->getBirth(),
            $keys[7] => $this->getEmail(),
            $keys[8] => $this->getGroups(),
            $keys[9] => $this->getStatus(),
            $keys[10] => $this->getRole(),
            $keys[11] => $this->getJoindate(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setAdds($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setPhone($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setBirth($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setEmail($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setGroups($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setStatus($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setRole($arr[$keys[10]]);
        }
        if (array_key_exists($keys[11], $arr)) {
            $this->setJoindate($arr[$keys[11]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_ADDS)) {
            $criteria->add(UserTableMap::COL_ADDS, $this->adds);
        }
        if ($this->isColumnModified(UserTableMap::COL_PHONE)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_JOINDATE)) {
            $criteria->add(UserTableMap::COL_JOINDATE, $this->joindate);
        }
