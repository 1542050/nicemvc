...
class ProductTableMap extends TableMap
{
    ...
    /**
     * the column name for the kash field
     */
    const COL_KASH = 'product.kash';

    /**
     * the column name for the kash_user_create field
     */
    const COL_KASH_USER_CREATE = 'product.kash_user_create';

    /**
     * the column name for the kash_user_adv field
     */
    const COL_KASH_USER_ADV = 'product.kash_user_adv';

    /**
     * the column name for the kash_user_scan field
     */
    const COL_KASH_USER_SCAN = 'product.kash_user_scan';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Kash', 'KashUserCreate', 'KashUserAdv', 'KashUserScan', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'kash', 'kashUserCreate', 'kashUserAdv', 'kashUserScan', ),
        self::TYPE_COLNAME       => array(ProductTableMap::COL_ID, ProductTableMap::COL_NAME, ProductTableMap::COL_KASH, ProductTableMap::COL_KASH_USER_CREATE, ProductTableMap::COL_KASH_USER_ADV, ProductTableMap::COL_KASH_USER_SCAN, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'kash', 'kash_user_create', 'kash_user_adv', 'kash_user_scan', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Kash' => 2, 'KashUserCreate' => 3, 'KashUserAdv' => 4, 'KashUserScan' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'kash' => 2, 'kashUserCreate' => 3, 'kashUserAdv' => 4, 'kashUserScan' => 5, ),
        self::TYPE_COLNAME       => array(ProductTableMap::COL_ID => 0, ProductTableMap::COL_NAME => 1, ProductTableMap::COL_KASH => 2, ProductTableMap::COL_KASH_USER_CREATE => 3, ProductTableMap::COL_KASH_USER_ADV => 4, ProductTableMap::COL_KASH_USER_SCAN => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'kash' => 2, 'kash_user_create' => 3, 'kash_user_adv' => 4, 'kash_user_scan' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('kash', 'Kash', 'DOUBLE', true, null, null);
        $this->addColumn('kash_user_create', 'KashUserCreate', 'DOUBLE', true, null, null);
        $this->addColumn('kash_user_adv', 'KashUserAdv', 'DOUBLE', true, null, null);
        $this->addColumn('kash_user_scan', 'KashUserScan', 'DOUBLE', true, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProductTableMap::COL_KASH);
            $criteria->addSelectColumn(ProductTableMap::COL_KASH_USER_CREATE);
            $criteria->addSelectColumn(ProductTableMap::COL_KASH_USER_ADV);
            $criteria->addSelectColumn(ProductTableMap::COL_KASH_USER_SCAN);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.kash');
            $criteria->addSelectColumn($alias . '.kash_user_create');
            $criteria->addSelectColumn($alias . '.kash_user_adv');
            $criteria->addSelectColumn($alias . '.kash_user_scan');
        }
    }
